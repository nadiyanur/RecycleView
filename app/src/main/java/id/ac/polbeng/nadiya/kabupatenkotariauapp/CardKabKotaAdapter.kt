package id.ac.polbeng.nadiya.kabupatenkotariauapp
...
import id.ac.polbeng.nadiya.kabupatenkotariauapp.databinding.ItemCardKabkotaBinding
...
class CardKabKotaAdapter(private val listKabKota: ArrayList<KabKota>):
    ...
    companion object {
        fun setOnItemClickCallback(onItemClickCallback: CardKabKotaAdapter.OnItemClickCallback) {
